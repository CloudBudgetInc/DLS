...
export default class AssessmentReportForLT extends LightningElement {
    ...
    showSpinner = false;    
    viewMode = true;
    activeSections = ['PERFORMANCE IN THE SKILLS','QUALITATIVE FACTORS','CURRENT LANGUAGE PROFICIENCY SCORES (ILR 0-5)','PROFICIENCY SCORES'];
    ...
    set assessmentReportRec(value){
        ...
        this.isLTDODA = this.assessmentReport.Project__r && this.assessmentReport.Project__r.AcctSeed__Account__r && this.assessmentReport.Project__r.AcctSeed__Account__r.Name.toLowerCase().includes("doda");        
